...
writeInstructions :-
  ...
  write_ln("\nWhen you begin the simulation, it will stop, once there are no active transitions left. If it never happens, then to abort a transition press Ctrl+C, then A.").
